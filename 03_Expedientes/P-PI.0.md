...
La accion local inmediata es ejecutar casos de equivalencia de proyecciones derivados de `PPI-MARCO-CORE-001`.
...
- Ejecutar `PPI-EQ-001` y `PPI-EQ-002` antes de cualquier promocion formal.
