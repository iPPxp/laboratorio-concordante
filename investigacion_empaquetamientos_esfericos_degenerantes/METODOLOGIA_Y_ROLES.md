...
| Ingenieria computacional | Ejecucion determinista, exportacion, pruebas | `run_initial_study.py`, `tests/` | Sin red, IA, dinamica fisica ni optimizador oculto |
...
1. Usar una version de Python compatible y `numpy` segun `requirements.txt`.
...
- Doce pruebas unitarias cubren normalizacion, umbrales cerrados de tetraedro y octaedro, cardinalidades, distincion HCP y dos resultados negativos/positivos de inclusion literal.
