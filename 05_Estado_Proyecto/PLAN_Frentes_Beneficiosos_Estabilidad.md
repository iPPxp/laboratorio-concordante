...
| `H-B.6` / `H-B.7` | precisa deuda viva de H-B | puede reabrir discusion teorica amplia | frente de limpieza conceptual |
...
Prioridad sugerida posterior al cierre de `AUT-001`: si se busca continuar el Auditor, implementacion no mutante conforme `C-002`. Si se busca limpiar deuda conceptual sin abrir formalizacion pesada, fichas de alcance para `H-B.6` y `H-B.7`.
