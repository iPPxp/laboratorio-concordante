...
- `AUT-001_Decision_Cierre_Tecnico_Provisional.md` (`D-2026-07-02-021`): cierre tecnico provisional aceptado; cierre operativo completo queda pendiente de ejecucion local directa.
...
- `HXI-001_Decision_Pausa_Operativa.md`: `HXI-001` queda en pausa operativa, sin admision de `H-Xi`.
...
- `PSI-001_Decision_Estatus_Ejemplos_Conceptuales.md`: `EX-PSI-001` a `EX-PSI-005` aceptados como bateria conceptual provisional no clinica dentro de `PSI-001`.
- `PSI-001_Decision_Estatus_Criterio_Transformacion.md`: `CRIT-PSI-TR-001` aceptado como criterio provisional operativo dentro de `PSI-001`.
- `PSI-001_Decision_Estatus_Definicion_Organizacion.md`: `DEF-PSI-ORG-001` aceptada como definicion provisional operativa dentro de `PSI-001`.
- `PSI-001_Decision_Estatus_A-PSI-001.md`: `A-PSI-001` aceptado como axioma candidato operativo dentro de `PSI-001`.
- `PSI-001_Decision_Apertura.md`: `PSI-001` abierto como frente psicologico inicial no clinico.
...
- `PSI-001_Auditoria_A-PSI-001.md`.
- `PSI-001_Auditoria_Definicion_Organizacion.md`.
- `PSI-001_Auditoria_Criterio_Transformacion.md`.
- `PSI-001_Auditoria_Ejemplos_Conceptuales.md`.
...
- `P-PI_Decision_Ruta_Operativa.md`.
...
- `PSI-001_Decision_Apertura.md`.
- `PSI-001_Decision_Estatus_A-PSI-001.md`.
- `PSI-001_Decision_Estatus_Definicion_Organizacion.md`.
- `PSI-001_Decision_Estatus_Criterio_Transformacion.md`.
- `PSI-001_Decision_Estatus_Ejemplos_Conceptuales.md`.
...
- `DEF-PSI-ORG-001` en `03_Expedientes/PSI-001_Definicion_Organizacion_Experiencia_Psicologica.md`, vigente solo dentro de `PSI-001`.
...
- `CRIT-PSI-TR-001` en `03_Expedientes/PSI-001_Criterio_Transformacion_Experiencia_Psicologica.md`, vigente solo dentro de `PSI-001`.

Ejemplos conceptuales registrados:

- `EX-PSI-001` a `EX-PSI-005` en `03_Expedientes/PSI-001_Ejemplos_Conceptuales_No_Clinicos.md`, vigentes solo dentro de `PSI-001`.

Casos conceptuales de transformacion registrados:

- `CAS-PSI-001` a `CAS-PSI-006` en `03_Expedientes/PSI-001_Casos_Transformacion_No_Clinicos.md`, vigentes solo dentro de `PSI-001`; no clinicos, no canonicos y no admisorios de `H-Xi`.
...
- `PSI-MAP-CONT-001` en `03_Expedientes/PSI-001_Mapa_Continuidad_Conceptual.md`, vigente solo dentro de `PSI-001`; no clinico, no canonico y no admisorio de `H-Xi`.
...
- `HXI-001_Matriz_Pruebas_HXI-R.md`, matriz provisional operativa sobre `EX-PSI-001` a `EX-PSI-005`; aceptada sin admision de `H-Xi`.
...
1. `HANDOFF.md`
2. `03_Expedientes/REC-001.md`
3. `03_Expedientes/REC-001_Mapa_Reconciliacion_Canon_Baselines.md`
4. `03_Expedientes/RH-002.md`
5. `04_Registro_Historico/2026-07-01_descargas_usuario_001/RESUMEN_PROCESAMIENTO.md`
6. `PROMPT_MAESTRO.md`
7. `05_Estado_Proyecto/ESTADO_ACTUAL.md`
8. `01_Canon/M-000_Reglas_Fundamentales.md`
9. `01_Canon/M-001_Auditoria_Arquitectonica.md`
