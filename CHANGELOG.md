...
- Incorporado `AO-DOC04-WIDE-001` al Documento 04 como formalizacion amplia v0: contrato comun de operador, `operator_trace`, `Pi_doc`, `Pi_rep`, `Pi_op`, `Eq_local`, `Conf_local`, `Gate_AO` y perfiles restringidos R4/Gamma.
- Creados `AO-001_Formalizacion_Amplia_Doc04.md`, `AO-001_Auditoria_Formalizacion_Amplia_Doc04.md` y `AO-001_Decision_Formalizacion_Amplia_Doc04.md`; registrada `D-2026-07-06-006`.
- Actualizados `CURRENT_STATE.md`, `ESTADO_ACTUAL.md`, `README.md`, `DECISIONES.md`, `REVISION_FORMALIZACION_PENDIENTE.md`, `HANDOFF.md` y `HANDOFF_PACKAGE.md` para dejar Documento 04 amplio atendido en v0 documental y conservar abiertas Confluencia global, Equivalencia global, relacion con `REPORT_LAYER`, exportacion general R4/Gamma y maduracion de `TCS-001`.
- Creado `AO-DOC04-WIDE-TEST-001` en `06_Automatizacion/ao_doc04_wide_tests.py` con fixture `06_Automatizacion/fixtures/ao_doc04_wide_cases.json`: 8 casos locales, 8 aprobados, 0 fallos, sin permiso de transformacion.
- Integrado `AO-DOC04-WIDE-TEST-001` a `DO-LAB-RUN-001` y a los reportes `ao_doc04_wide_report.md` / `.json`.
- Precisada en Documento 04 la relacion `Pi_rep(REPORT_LAYER, C, W) -> R_rep | B`: `REPORT_LAYER` es entrada local de proyeccion de reporte, no operador, decision, permiso, verificacion posterior ni Nivel C.
- Creados `AO-001_Pruebas_AO-DOC04-WIDE_REPORT_LAYER.md`, `AO-001_Relacion_REPORT_LAYER_Doc04_Amplio.md`, `AO-001_Auditoria_Pruebas_AO-DOC04-WIDE_REPORT_LAYER.md` y `AO-001_Decision_Pruebas_AO-DOC04-WIDE_REPORT_LAYER.md`; registrada `D-2026-07-06-007`.
- Actualizados `CURRENT_STATE.md`, `ESTADO_ACTUAL.md`, `README.md`, `DECISIONES.md`, `REVISION_FORMALIZACION_PENDIENTE.md`, `HANDOFF.md` y `HANDOFF_PACKAGE.md` para dejar atendida la prueba inicial de `AO-DOC04-WIDE-001` y conservar abiertas pruebas heterogeneas adicionales, Confluencia global, Equivalencia global y exportacion R4/Gamma.
- Decidida `MOC-ROUTE-010` mediante `MOC-NEXT-ROUTES-010`: la ruta posterior vigente queda como `MOC-ROUTE-011`, mantenimiento teorico-operativo sin ejecucion. Creados documento, auditoria y decision; registrada `D-2026-07-06-008`.
- Cerrado tecnicamente `R001-001`: `R001-TABLE-CHECK-001` y `R001-TB-001` quedan conservados como herramienta/relacion local de apoyo a `AO-001`, sin cerrar Confluencia global ni Equivalencia global. Registrada `D-2026-07-06-009`.
- Cerrado tecnicamente `AUT-002`: `referencia_historica_transferida` queda conservada como regla tecnica para referencias historicas a `PSI-001*` eliminado; cualquier dependencia psicologica sustantiva futura exige decision puente. Registrada `D-2026-07-06-010`.
- Cerrado `AUD-001` como expediente completo en version documental/operativa v0; `REPORT_LAYER`, R4/Gamma y suite completa quedan conservados en perfil local sin exportacion general. Registrada `D-2026-07-06-011`.
- Cerrado `HXI-001` en mantenimiento local; `H-Xi` sigue no admitida y `Xi_eval` queda solo como herramienta local historica/auxiliar. Registrada `D-2026-07-06-012`.
- Actualizados `CURRENT_STATE.md`, `05_Estado_Proyecto/ESTADO_ACTUAL.md`, `README.md`, `05_Estado_Proyecto/DECISIONES.md`, `HANDOFF.md`, `HANDOFF_PACKAGE.md` y `REVISION_FORMALIZACION_PENDIENTE.md` para reflejar los cierres defensibles y las deudas que permanecen abiertas.
- Ejecutada `MOC-ROUTE-012`: creada relacion documental local `MOC/C-001/C-002`; `C-001` queda como frontera tecnica y `C-002` como secuencia operativa, sin modificar Nivel C, sin crear `C-003` y sin promover MOC.
- Creados `MOC-001_Relacion_Documental_C001_C002.md`, `MOC-001_Auditoria_Relacion_Documental_C001_C002.md` y `MOC-001_Decision_Relacion_Documental_C001_C002.md`; registrada `D-2026-07-06-013`.
- Actualizados `CURRENT_STATE.md`, `05_Estado_Proyecto/ESTADO_ACTUAL.md`, `README.md`, `05_Estado_Proyecto/DECISIONES.md`, `HANDOFF.md`, `HANDOFF_PACKAGE.md` y `REVISION_FORMALIZACION_PENDIENTE.md` para retirar la deuda abierta total de relacion `MOC/C-001/C-002` y conservar como condicional cualquier especificacion tecnica futura.
- Justificado `REPORT_LAYER` frente a Nivel C: creado `AO-REPORT-LAYER-NIVEL-C-001`; `REPORT_LAYER` permanece local pre-C, sin crear `C-003` ni contrato global independiente. Registrada `D-2026-07-06-014`.
- Creado `AUT-003` y la herramienta no mutante `REPORT-LAYER-C002-GATE-001` conforme a `C-002`, con fixture, pruebas unitarias, reportes Markdown/JSON e integracion a `DO-LAB-RUN-001`; no autoriza transformaciones ni modo mutante. Registrada `D-2026-07-06-015`.
- Revisada la reconciliacion `RH-001` / `PM-001`: `PM-001` queda solo como deuda historica condicionada, no como expediente activo ni protocolo materializado. Registrada `D-2026-07-06-016`.
- Actualizados `CURRENT_STATE.md`, `05_Estado_Proyecto/ESTADO_ACTUAL.md`, `README.md`, `05_Estado_Proyecto/DECISIONES.md`, `HANDOFF.md`, `HANDOFF_PACKAGE.md`, `REVISION_FORMALIZACION_PENDIENTE.md`, `06_Automatizacion/README.md` y `06_Automatizacion/reportes/README.md` para reflejar `D-2026-07-06-014` a `D-2026-07-06-016`.
- Abierto `AO-PPI-BRIDGE-002` como bateria fuerte local no mutante de Confluencia y Equivalencia; incluye equivalencia fuerte local, confluencia fuerte local, divergencias clasificadas y bloqueos por testigo, autoridad y `REPORT_LAYER` incompleto.
- Creada herramienta `06_Automatizacion/ao_ppi_bridge_002.py`, fixture `06_Automatizacion/fixtures/ao_ppi_bridge_002_cases.json`, prueba unitaria y reportes Markdown/JSON; integrada a `DO-LAB-RUN-001`.
- Creados `AO-001_Puente_Confluencia_Equivalencia_002.md`, `AO-001_Auditoria_Puente_Confluencia_Equivalencia_002.md` y `AO-001_Decision_Puente_Confluencia_Equivalencia_002.md`; registrada `D-2026-07-06-017`.
- Actualizados `CURRENT_STATE.md`, `05_Estado_Proyecto/ESTADO_ACTUAL.md`, `README.md`, `05_Estado_Proyecto/DECISIONES.md`, `HANDOFF.md`, `HANDOFF_PACKAGE.md`, `REVISION_FORMALIZACION_PENDIENTE.md`, `AO-001.md`, `06_Automatizacion/README.md` y `06_Automatizacion/reportes/README.md` para reflejar que el avance es local fuerte y que Confluencia global y Equivalencia global siguen abiertas.
- Preparado `AO-PPI-BRIDGE-003` como matriz de condiciones faltantes para cierre global: 10 condiciones, 3 satisfacciones locales, 5 faltantes globales y 2 bloqueos por alcance; `global_closure_authorized` queda en `false`.
- Ampliados los casos heterogeneos de `REPORT_LAYER` dentro de `AO-PPI-BRIDGE-003`: 9 casos no mutantes, 9 aprobados, con compatibilidades, divergencia clasificada y bloqueos por testigo, decision, autoridad y modo mutante.
- Creada herramienta `06_Automatizacion/ao_ppi_bridge_003.py`, fixture `06_Automatizacion/fixtures/ao_ppi_bridge_003_matrix.json`, prueba unitaria y reportes Markdown/JSON; integrada a `DO-LAB-RUN-001`.
- Creados `AO-001_Matriz_Condiciones_Cierre_Global_003.md`, `AO-001_Auditoria_Matriz_Condiciones_Cierre_Global_003.md` y `AO-001_Decision_Matriz_Condiciones_Cierre_Global_003.md`; registrada `D-2026-07-06-018`.
- Preparado `AO-REPORT-SERIAL-001` como serializacion interfrente local de `REPORT_LAYER`: contrato `REPORT-LAYER-SERIAL-v0`, versionado local, mapa de campos, campos protegidos y 10 casos sinteticos.
- Creada herramienta `06_Automatizacion/report_layer_serialization.py`, fixture `06_Automatizacion/fixtures/report_layer_serialization_cases.json`, prueba unitaria y reportes Markdown/JSON; integrada a `DO-LAB-RUN-001`.
- Creados `AO-001_Serializacion_REPORT_LAYER_001.md`, `AO-001_Auditoria_Serializacion_REPORT_LAYER_001.md` y `AO-001_Decision_Serializacion_REPORT_LAYER_001.md`; registrada `D-2026-07-06-019`.
- Actualizados `CURRENT_STATE.md`, `05_Estado_Proyecto/ESTADO_ACTUAL.md`, `README.md`, `05_Estado_Proyecto/DECISIONES.md`, `REVISION_FORMALIZACION_PENDIENTE.md`, `HANDOFF.md`, `HANDOFF_PACKAGE.md`, `AO-001.md`, `06_Automatizacion/README.md` y `06_Automatizacion/reportes/README.md` para conservar `REPORT_LAYER` local pre-C, con `global_export_authorized: false`.
- Preparado `AO-TCS-REL-001` como relacion local `AO/TCS`: mapea fallos AO hacia tipos provisionales `TCS-001`, conserva `tcs_canonical: false` y no autoriza cierre global.
- Preparado `AO-AUTH-GLOBAL-001` como criterio local de autoridad entre niveles: separa autoridad local, documental, tecnica y superior de evidencia pasiva, reporte automatizado y evidencia externa sintetica.
- Preparado `AO-EXT-COV-001` como cobertura externa amplia sintetica no regulada: repositorio documental, release tecnico, migracion ficticia, politicas, conflicto de revisores, divergencia externa, caso sin testigo y autoridad excedida.
- Preparado `AO-PPI-BRIDGE-004` como matriz consolidada posterior: 12 condiciones, 5 `satisfecha_local`, 2 `parcial_local`, 2 `faltante_global` y 3 `bloqueada_por_alcance`; `global_closure_authorized` queda en `false`.
